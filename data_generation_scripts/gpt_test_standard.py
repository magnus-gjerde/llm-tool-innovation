"""
This script lets you generate data from the GPT models in the STANDARD condition.
...
def query_function(prompt):
    ...
    response_afford = completion1.choices[0].message.content        # extract only the text output
